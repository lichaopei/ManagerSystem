	...
	<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-right" role="navigation">
					<ul class="nav1 ace-nav">
						<li class="light-blue drop-down">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${pageContext.request.contextPath}/resource/assets/avatars/user.jpg" alt="Jason's Photo" />
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/construct/employee/list.action"
					...
					<li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/attendance/attendance/list.action"
								target="mainframe"> <i class="icon-double-angle-right">
								</i> 员工考勤
							</a></li>
							<li><a
					...
					<li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/system/admin/list.action"
								target="mainframe"> <i class="icon-double-angle-right"></i>
									用户管理
							</a></li>

							<li><a
								href="${pageContext.request.contextPath}/system/adminpopedom/list.action"
								target="mainframe"> <i class="icon-double-angle-right"></i>
									权限管理
							</a></li>
						</ul></li>
