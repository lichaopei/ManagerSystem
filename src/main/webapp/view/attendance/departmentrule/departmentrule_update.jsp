				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-append date form_datetime">
							<input type="text" size="16" name="startTimeAm" id="d4" readonly class="form_datetime"
								 value="${department.startTimeAm}" />
