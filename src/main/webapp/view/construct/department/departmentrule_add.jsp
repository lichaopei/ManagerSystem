...
<body>
	...
	<form action="${pageContext.request.contextPath}/construct/department/add.action"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-append date form_datetime">
    						<input size="16" type="text" id="datetimeStartAM" name="startTimeAm" readonly class="form_datetime">
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-append date form_datetime">
    						<input size="16" type="text" id="datetimeEndAM" name="endTimeAm" readonly class="form_datetime">
    						<span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-append date form_datetime">
    						<input size="16" type="text" id="datetimeStartPM" name="startTimePm" readonly class="form_datetime">
    						<span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-append date form_datetime">
    						<input size="16" type="text" id="datetimeEndPM" name="endTimePm" readonly class="form_datetime">
    						<span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
				</div>
