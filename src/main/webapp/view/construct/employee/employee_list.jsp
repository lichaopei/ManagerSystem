...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/construct/employee/list.action"
		...
		<div class="row alert alert-info" style="margin: 0px; padding: 3px;">
			...
			<input type="submit" class="btn btn-danger" value="查询" /> <input
				...
				onClick="javascript:window.location='${pageContext.request.contextPath}/construct/employee/beforeadd.action'" />
		</div>
	</form>
	...
	<div class="row" style="padding: 15px; padding-top: 0px;" align="right">
		...
		<display:table class="table table-condensed table-striped" name="list"
			...
			<display:column property="employeeGender" title="性别"></display:column>
