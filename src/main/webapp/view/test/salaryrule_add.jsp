...
<body>
	...
	<form action="${pageContext.request.contextPath}/salaryrule/add.action"
		...
		<!--开始 -->
			<div class="col-sm-5">
				<div class="form-group">
    				...
    				<input type="number" name="baseSalary"  value=""  min="0"  required="required"
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-8">
					<input type="number" name="positionSalary"  value=""  min="0" required="required"
    						class="form-control input-sm" />
			...
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-8">
					<input type="number" name="targetMoney"  value=""  min="0" required="required"
    						class="form-control input-sm" />
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-8">
					<input type="number" name="UpPercent"  value=""  step="0.01" min=0  max=1 required="required"
    						class="form-control input-sm" />
			...
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-8">
					<input type="number" name="jxPercent"  value=""  step="0.01"  min=0  max=1  required="required"
    						class="form-control input-sm" />
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-8">
					<input type="number" name="scoreMoney"  value=""  min=0   required="required"
    						class="form-control input-sm" />
					</div>
				</div>
			</div>
